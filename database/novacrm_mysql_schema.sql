-- =============================================================================
-- NovaCRM + NovaERP  |  Enterprise Multi-Tenant Schema (MySQL 8.0+)
-- =============================================================================
-- Architecture: Shared database + shared schema, row isolation via tenant_id
-- Inspired by patterns used in Salesforce / Zoho / HubSpot / NetSuite style SaaS
--
-- HOW TO USE IN MYSQL WORKBENCH:
--   1. File → Open SQL Script → select this file
--   2. Or paste into a new SQL tab
--   3. Execute (lightning bolt) — creates DB `novacrm` + all objects + seed data
--
-- Default platform admin after seed:
--   email:    admin@novacrm.com
--   password: Admin@Nova2026   (bcrypt hash below — change immediately)
-- =============================================================================
...
DROP DATABASE IF EXISTS novacrm;
...
-- now attach product_id FK on tickets
ALTER TABLE tickets
...
INSERT INTO feature_tips (id, tenant_id, module_key, section_key, title, body, tip_type, sort_order) VALUES
...
-- =============================================================================
-- DONE
-- Next: run backend `npm run prisma:seed` to create a demo tenant + real admin hash
-- =============================================================================
